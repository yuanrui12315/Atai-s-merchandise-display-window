export default {
  ...
  COMMON: {
    ...
    SEARCH_NO_RESULTS: 'Aucun article correspondant',
    SEARCH_NO_RESULTS_HINT: 'Vérifiez vos mots-clés ou essayez une autre recherche.',
    SEARCH_LIST_EMPTY:
      "Produit introuvable. Il n'est peut-être pas en ligne — contactez-nous via WeChat.",
