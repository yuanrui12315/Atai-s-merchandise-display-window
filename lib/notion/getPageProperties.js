...
// 强制格式化分类：确保它始终是一个纯文字数组，解决报错且保证跳转有内容
  if (properties.category) {
    const categoryData = Array.isArray(properties.category) ? properties.category : [properties.category]
    properties.category = categoryData.map(c => {
