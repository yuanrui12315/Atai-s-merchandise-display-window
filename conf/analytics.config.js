 ...
 */
module.exports = {
  ANALYTICS_VERCEL: process.env.NEXT_PUBLIC_ANALYTICS_VERCEL !== 'false', // Vercel 访问量统计，默认开启（可在 Vercel 环境变量设 false 关闭）
  // 不蒜子已弃用（国内常连不上 busuanzi.ibruce.info）；沿用 siteConfig 硬关，此项仅作文档占位
