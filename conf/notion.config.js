...
module.exports = {
  ...
  NOTION_PROPERTY_NAME: {
    ...
    title: process.env.NEXT_PUBLIC_NOTION_PROPERTY_TITLE || 'title', // 文章标题，Notion 常见列名：title / Name / Aa title
    ...
    slug: process.env.NEXT_PUBLIC_NOTION_PROPERTY_SLUG || '自定义链接', // 仍兼容 slug、链接别名
